...
<head>
	...
	<!-- Colour Schemes
		...
		<link rel="stylesheet" href="../admins/resources/css/blue.css" type="text/css" media="screen" />
		
		<link rel="stylesheet" href="../admins/resources/css/red.css" type="text/css" media="screen" />  
	...
	<!--[if lte IE 7]>
			<link rel="stylesheet" href="../admins/resources/css/ie.css" type="text/css" media="screen" />
		<![endif]-->
	...
	<!--[if IE]><script type="text/javascript" src="../admins/resources/scripts/jquery.bgiframe.js"></script><![endif]-->


	<!-- Internet Explorer .png-fix -->

	<!--[if IE 6]>
			<script type="text/javascript" src="../admins/resources/scripts/DD_belatedPNG_0.0.7a.js"></script>
			...
			<div id="sidebar-wrapper">
				...
				<ul id="main-nav">
					...
					<li>
						...
						<ul>
							<li><a class="current" href="#">Product List</a></li>
							...
							<fieldset>
								...
								<p>
									...
									<input class="text-input small-input" type="text" id="small-input"
										name="small-input" /> <span class="input-notification success png_bg">Successful
										message</span>
								...
								<p>
									...
									<input class="text-input medium-input datepicker" type="text" id="medium-input"
										name="medium-input" /> <span class="input-notification error png_bg">Error
										message</span>
								</p>
								...
								<p>
									...
									<input type="checkbox" name="checkbox1" /> This is a checkbox <input type="checkbox"
